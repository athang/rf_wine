...
min_lam_lasso <- cv.out$lambda.min ; min_lam # min lambda = 0.008554764 (log = -2.067792)
best_lam_lasso <- cv.out$lambda.1se; best_lam # best lambda =  0.1530147 (log = -0.8152668)
...
# find MSE
MSE3 <- mean((lasso.pred - test_b2)^2); MSE3 # 1.3118
# coefficients
